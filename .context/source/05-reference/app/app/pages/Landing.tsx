...
// Journey OS Brand-Aligned: Education Pillar (Evergreens) + True Blues
...
export default function JourneyOSLanding() {
  ...
  const personas = {
    faculty: {
      ...
      benefits: [
        ...
        { title: "Equity woven into every vignette", desc: "Diverse patient demographics and social determinants are part of how questions are generated — reflecting the communities we serve." },
      ],
      steps: [
  ...
  const features = [
    ...
    { icon: "✦", title: "Health equity woven into the fabric", desc: "Representation isn't an add-on. It's part of how content is generated and measured.", detail: "Diverse patient demographics, social determinants, and community context embedded in the generation pipeline." },
  ];
