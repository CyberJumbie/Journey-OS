...
export default function FrameworkManagement() {
  ...
  const [importResult, setImportResult] = useState<{ standards: number; elements: number; subElements: number; totalNodes: number; totalRelationships: number } | null>(null);
  const [isImporting, setIsImporting] = useState(false);

  // Mock data - replace with API calls
  const [frameworkData, _setFrameworkData] = useState<Record<Framework, FrameworkNode[]>>({
    LCME: [],
    ACGME: [],
    EPA: [],
    USMLE: [],
