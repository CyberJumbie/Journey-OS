...
import { BarChart3, Users, Settings, Shield, Activity, Award, Download, CheckCircle2, AlertTriangle, FileText, GitBranch, GraduationCap, Layers } from "lucide-react";
        ...
        <div style={{ padding: isMobile ? "20px 16px" : isTablet ? "24px 24px" : "28px 32px", maxWidth: 1400 }}>
          ...
          <div style={{
            ...
            {[
              ...
              { label: "Compliant", value: reports.filter((r: AccreditationReport) => r.status === "compliant").length, color: C.green },
              { label: "Action Items", value: reports.reduce((sum: number, r: AccreditationReport) => sum + r.action_items, 0), color: "#fa9d33" },
            ].map((stat) => (
