...
export default function GenerationSpecificationWizard() {
  ...
  const [_useRecommended, setUseRecommended] = useState(false);
  ...
  // Step 3: Confirmation
  const [estimatedCost, _setEstimatedCost] = useState(4.5);
  const [estimatedDuration, _setEstimatedDuration] = useState(8);
