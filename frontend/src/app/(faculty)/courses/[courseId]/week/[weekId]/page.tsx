...
export default function WeekView() {
  ...
  const weekData = {
    number: parseInt(String(weekId) || "1"),
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 gap-4">
          <Card 
            ...
            onClick={() => router.push(`/courses/${courseId}/week/${weekId}/generate`)}
          >
          ...
          <Card 
            className="cursor-pointer hover:border-primary-color transition-colors"
            onClick={() => router.push(`/courses/${courseId}/week/${weekId}/generate-test`)}
          >
            <CardContent className="pt-6 text-center">
              <div className="w-12 h-12 bg-primary-color/10 rounded-lg flex items-center justify-center mx-auto mb-3">
          ...
          <Card 
            className="cursor-pointer hover:border-primary-color transition-colors"
            onClick={() => router.push(`/courses/${courseId}/week/${weekId}/generate-quiz`)}
          >
            <CardContent className="pt-6 text-center">
              <div className="w-12 h-12 bg-primary-color/10 rounded-lg flex items-center justify-center mx-auto mb-3">
          ...
          <Card 
            className="cursor-pointer hover:border-primary-color transition-colors"
            onClick={() => router.push(`/courses/${courseId}/week/${weekId}/generate-handout`)}
          >
            <CardContent className="pt-6 text-center">
              <div className="w-12 h-12 bg-primary-color/10 rounded-lg flex items-center justify-center mx-auto mb-3">
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Button 
                    size="sm"
                    onClick={() => router.push(`/courses/${courseId}/week/${weekId}/upload-materials`)}
                  >
